...
- 평일 근무일(weekday_work_days)은 0~5. 평일도 요일별 근무 빈도로 환산해 합산한다(격주 평일=0.5, 월2회=0.5, 매주=1).
  = '주당 평균 근무일'이다. 특정 주에만 나오는 격주 요일을 매주처럼 1로 세지 마라.
  예) '1주 화목 + 2주 화목금'(금만 격주) → 화 매주1 + 목 매주1 + 금 격주0.5 = 2.5. (주별 2일·3일의 평균 2.5와 같다.)
